...
import (
	...
	nexusv1 "github.com/bergundy/protoc-gen-nexus/gen/nexus/v1"
...
func (p *Plugin) genCodeGenerationHeader(f *jen.File, target *protogen.File) {
	f.PackageComment("Code generated by protoc-gen-nexus. DO NOT EDIT.")
	f.PackageComment("versions: ")
	f.PackageComment(fmt.Sprintf("    protoc-gen-nexus %s (%s)", p.version, p.commit))
